...
export class AdministratorComponent implements OnInit {
      ...
      response.parameters.forEach((itm,index) => {
       ...
       //console.log(this.sections);
        ...
        this.sections.push({
          ...
          description: this.translateService.instant("alerts.files"),
          upload: (i, f) => {
  ...
  fileChangeEvent(evt: any, variable: any) {
    if (variable.files.length < variable.countFiles || variable.countFiles == -1) {
      ...
      this.alertService.warnAlert(
        "Ooops!",
        this.translateService.instant("alerts.many-files")
        ,
        () => {
          ////console.log("hola");
        }
      ...
      .subscribe(
        (response: any) => {
          ...
          this.alertService.successAlert(
            ...
            this.translateService.instant("alerts.img-update"),
            () => {
              ////console.log("hola");
            }
          );
        ...
        (error: HttpErrorResponse) => {
          ...
          this.alertService.errorAlert(
            "Ooops!",
            this.translateService.instant("alerts.error"),
            () => {
              ////console.log("hola");
            }
          );
